...
We — contributors and maintainers of CAESAR — pledge to make
...
requests, discussions, the project's chat channels (if any), and when
...
may be reported to the maintainers at the contact listed in
...
1. **Correction** — Private, written warning, providing clarity around
